    ...
    (function (core) {
        ...
        var SkeletonJson = (function () {
            ...
            SkeletonJson.prototype.readSkeletonData = function (json) {
                ...
                // დამატება
                this.version = skeletonData.version === undefined ? 0 : parseInt(skeletonData.version.substring(0, 3).replace('.', ''));
                if (root.bones) {
                ...
                if (root.skins) {
                    ...
                    if (this.version < 38) {
                        var skins = new Array();
                        for (var skinsName in root.skins) {
                            var name = skinsName;
                            var attachments = root.skins[skinsName];
                            skins.push({name: name, attachments: attachments});
                        }
                        root.skins = skins;
                    }
...
(function (pixi_spine) {
    ...
    var Spine = (function (_super) {
        ...
        Spine.prototype.destroy = function (options) {
            // დამატება
            if (this.skeleton !== null) {
                this.skeleton.autoUpdate = false;
...
(function (pixi_spine) {
    ...
    var AtlasParser = (function () {
        ...
        AtlasParser.use = function (resource, next) {
            ...
            // დამატება
            var metadataAtlasSuffix = metadata.spineAtlasSuffix || '.atlas.txt';
